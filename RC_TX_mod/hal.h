...
#define TMR_A_PERIOD          20000       // 20ms; servo update frequency; PWM period; 50Hz  
#define TICKS_PER_SEC         50          // 1 second
#define TICKS_PER_100_MS      5
