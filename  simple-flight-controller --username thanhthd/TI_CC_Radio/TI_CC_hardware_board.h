...
#define TI_CC_GDO0_PIN          0x40    // bit 6
/*
#define TI_CC_GDO1_PxOUT        P5OUT_
...
#define TI_CC_GDO2_PIN          0x80    // bit 7

#define TI_CC_CSn_PxOUT         P3OUT
#define TI_CC_CSn_PxDIR         P3DIR
#define TI_CC_CSn_PIN           0x01    // bit 0


//----------------------------------------------------------------------------
// Select which port will be used for interface to CCxxxx
//----------------------------------------------------------------------------
#define TI_CC_RF_SER_INTF       TI_CC_SER_INTF_USCIB0  // Interface to CCxxxx using SPI
