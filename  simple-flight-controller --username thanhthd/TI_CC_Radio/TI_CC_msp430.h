...
#define TI_CC_SPI_USART1_PxSEL  P3SEL
#define TI_CC_SPI_USART1_PxDIR  P3DIR
#define TI_CC_SPI_USART1_PxIN   P3IN
...
#define TI_CC_SPI_USCIA1_PxSEL  P3SEL
#define TI_CC_SPI_USCIA1_PxDIR  P3DIR
#define TI_CC_SPI_USCIA1_PxIN   P3IN
...
#define TI_CC_SPI_USCIB0_UCLK   0x08    // bit 3 port B
/*
...
#define TI_CC_SPI_USCIB1_UCLK   0x08    // bit 3 port B
*/
#define TI_CC_SPI_USI_PxDIR     P3DIR
#define TI_CC_SPI_USI_PxIN      P3IN
#define TI_CC_SPI_USI_SIMO      0x40
#define TI_CC_SPI_USI_SOMI      0x80
#define TI_CC_SPI_USI_UCLK      0x20

#define TI_CC_SPI_BITBANG_PxDIR P3DIR
#define TI_CC_SPI_BITBANG_PxOUT P3OUT
#define TI_CC_SPI_BITBANG_PxIN  P3IN
